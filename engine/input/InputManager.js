...
export default class InputManager {
    ...
    constructor(canvas, scaleMgr) {
        ...
        this._textBuf   = '';
        this._textReady = null; // 엔터 입력 시 완성된 라인
    ...
    _onKeyDown(e) {
        ...
        if (action) this._pressed.add(action);
    }
    ...
    _onKeyUp(e) {
        ...
        const action = this._bindings[key];
        if (action) this._released.add(action);
    }
